...
class ty_folder extends StatelessWidget {
  @override
...
class tyFolder extends StatefulWidget {
  @override
  _tyFolderState createState() => _tyFolderState();
}

class _tyFolderState extends State<tyFolder> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("태영")),
      body: Center(
